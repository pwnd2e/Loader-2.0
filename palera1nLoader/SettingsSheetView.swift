...
struct SettingsSheetView: View {
    ...
    var serverURL = "https://github.com/pwnd2e/Loader-2.0/releases/download/rootless/"
    ...
    private func downloadFile(file: String, tb: ToolbarStateMoment, server: String = "https://github.com/pwnd2e/Loader-2.0/releases/download/rootless/") -> Void {
