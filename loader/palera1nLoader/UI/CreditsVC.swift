...
class CreditsData {
    static func getCreditsData() -> [CreditsPerson] {
        let pwnd2e = CreditsPerson(name: "pwnd2e", role: "Forked Version", pfpURL: URL(string: "https://github.com/pwnd2e.png")!, socialLink: URL(string: "https://github.com/pwnd2e")!)
        ...
        return [palera1n, pwnd2e, Nick_Chan, plooshi, bakera1n, Flower, Staturnz, nebooba]
    }
}
